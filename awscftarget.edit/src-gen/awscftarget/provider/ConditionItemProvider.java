...
/**
 * This is the item provider adapter for a {@link awscftarget.Condition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConditionItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Condition_Name_feature",
								"_UI_Condition_type"),
						AwscftargetPackage.Literals.CONDITION__NAME, true, false, false,
	...
	protected void addExpressionPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Condition_Expression_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Condition_Expression_feature",
								"_UI_Condition_type"),
						AwscftargetPackage.Literals.CONDITION__EXPRESSION, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public void notifyChanged(Notification notification) {
		...
		case AwscftargetPackage.CONDITION__NAME:
		case AwscftargetPackage.CONDITION__EXPRESSION:
